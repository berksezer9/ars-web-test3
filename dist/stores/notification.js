...
const useNotificationStore = defineStore('notification', {
    ...
    actions: {
        ...
        notify(notification) {
            ...
            this.notifications[notification.options.id] = notification;
            ...
            if (!(typeof duration === 'number' && duration < 0.0)) {
                this.setTimeout(() => this.closeNotification(notification.options.id), 
                //uses "duration" if it is a positive number. otherwise uses the notification api's
                // default value 3_000
                typeof duration === 'number' && duration > 0.0 ? duration : 3000);
            }
            return notification;
        },
        ...
        getNotificationById(id) {
            var _a;
            return (_a = this.notifications[id]) !== null && _a !== void 0 ? _a : null;
        },
    }
});
